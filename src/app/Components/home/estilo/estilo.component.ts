...
export class EstiloComponent implements OnInit {
  ...
  images = [
    ...
    { src: '../../../../assets/tipos-cortes/Corte-moderno-desvanecido-bajo.jpg', name: 'Low Fade' },
    { src: '../../../../assets/tipos-cortes/fade-lineas.jpg', name: 'Fade con diseños laterales' },
    { src: '../../../../assets/tipos-cortes/Buzz-cut.jpg', name: 'Buzz Cut' },
    { src: '../../../../assets/tipos-cortes/Burst-fade.jpg', name: 'Burst Fade' },
    { src: '../../../../assets/tipos-cortes/Drop-fade.jpg', name: 'Drop Fade' },
